...
\HRule \\[0.5cm]
\begin{Huge}
	\bfseries{Learning a Hawk Parallelepiped: cryptanalysis of the Hawk digital signature scheme}\\[0.7cm] % Title of your document
\end{Huge}
\HRule \\[0.5cm]
...
\centerline{\includegraphics[scale=0.45]{figures/NT_PositivVenstrestilt_ENG.png}}
