...
In the recent 50 years or so, cryptography has become an enabler of secure communication, verification, and integrity of information, all of which are integral \todo{find better word than 'parts' here}parts of our digital world. \cite{KL20}
...
An important consideration when designing or analyzing the security of an asymmetric cryptosystem, is that the entire scheme is only as strong as its weakest part. \todo{Maybe find some direct source for this?}
