...
\section{HPP}
In this section we present the \textit{Learning a Parallelepiped} attack as described in \cite{NR09}. Note that in this section $\vec{v}$ denotes a \textit{row}-vector to follow the same notation as in \cite{NR09}.
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{hpp_parallelepiped_normal.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{hpp_normal_cube.png}
