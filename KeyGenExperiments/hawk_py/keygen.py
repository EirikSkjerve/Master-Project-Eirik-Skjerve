from hawk_py.poly import adjoint, isinvertible, poly_mul_ntt, poly_add, infnorm, l2norm
from hawk_py.ntrugen.ntrugen_hawk import ntru_solve
import hawk_py.ntrugen
from hawk_py.params import PARAMS
from hawk_py.codec import encode_public, encode_private
import hashlib
import numpy as np
from hawk_py.rngcontext import RngContext, SHAKE256x4
...
def hawkkeygen(logn, rng=None):
    ...
    f, g, F, G, _, _, _, priv, pub = hawkkeygen_unpacked(logn, rng)
    B = [f, g, F, G]
    return B, priv, pub
...
def hawkkeygen_unpacked(logn, rng=None):
    ...
    invq00 = hawk_py.ntrugen.fft.inv_fft(q00)
