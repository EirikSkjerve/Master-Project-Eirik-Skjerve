...
$\bb{V}[z_i] = 1$.
Now, denote by $\mu_4 = \bb{E}[z_i^4] = \mathlarger{\frac{1}{t} \sum_{i=1}^{n} z_i ^4}$. 
...
Generally the method changes $\delta$ to be greater in flat areas of the landscape, and $\delta$ to be lower in steep areas of the landscape.
